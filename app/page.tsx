    ...
    <div className="max-w-3xl">
      ...
      <div className="mb-8 mt-10" style={{ order: 4 }}>
        ...
        <div className="relative" style={{ userSelect: 'none' }}>
          ...
          <div style={{ position: 'absolute', left: '78.0%', top: '46.6%', width: '15.4%', height: '52.3%', overflow: 'hidden', background: 'white', fontFamily: "'Jost', sans-serif", zIndex: 3, display: 'flex', flexDirection: 'column' }}>
